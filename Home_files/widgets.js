if (!window.location.hostname.match('cloudflare.works') || "//static.zotabox.com/9/c/9c5d673cde8c68dd9cf991fd43c28a45".match('a641227e8963155fcc57d87f55ee1cb0')) {
        ...
        !(function (bootstrap) {
            ...
            Zotabox.prototype.initialize = function () {
                ...
                if (getCookie("zb-demo") == 1 || getCookie("zb-settings") == 1 || patt.test(hash) || bootstrap.data.embedWidgets.length != 0) {
                    require([bootstrap.staticURL + "/embed_widgets/bootstrap.js?" + 'ksdzjya'], function () {
            ...
            root: "//static.zotabox.com/9/c/9c5d673cde8c68dd9cf991fd43c28a45",
            domains: {
                "stats": "//stats.zotabox.com",
                "static": "//static.zbcdn3.net",
            ...
            staticURL: "//static.zbcdn3.net",
            dataURL: '//static.zbcdn3.net/9/c/9c5d673cde8c68dd9cf991fd43c28a45/data.js?1626169688759',
            bundleURL: '//static.zbcdn3.net/__ksdzjya/asset/bundle.js',
            widgetURLs: ["//static.zbcdn3.net/__ksdzjya/social_tab/default.js"],
            widgetInstallerClasses: ["Widgets.SocialTab.Default.Installer"],
            data: {
                "embedWidgets": [],
                "domain": {
                    "id": 26549,
                    "secure_id": "9c5d673cde8c68dd9cf991fd43c28a45",
                    "name": "Tools",
                    "phone_number": null,
                    "registed_domain": "toolshardwarejamaica.com",
                    "sms_number": null,
                    "email_address": null,
                    "whatsapp_contact_id": null,
                    "skype_profile_name": null,
                    "facebook_fanpage": "https://www.facebook.com/ToolsHardwareJa/",
