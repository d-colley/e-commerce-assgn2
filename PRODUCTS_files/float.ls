...
_ZLDSCREENNAME="toolshardwaresupplies"; //No I18N
_ZLDEMBEDNAME="toolshardwaresupplies";  //No I18N
...
function ZloadFiles()
{
  ...
  ocss.rel ="stylesheet";
  ocss.href = "https://css.zohocdn.com/salesiq/https/styles/floatsupportbtn_161fbac84abb26cb426bcf0f5fabff4b_.css";  
  ...
  try
  {
		...
		if(ie && document.compatMode!="CSS1Compat")
		{
				var ocss = document.createElement("link");
				ocss.rel ="stylesheet";
				ocss.href = "https://css.zohocdn.com/salesiq/https/styles/floatiebtnfix_bd3950693ed3fccc873b2dd28b340a90_.css";  
				headArr[0].appendChild(ocss);
		}
  ...
  oscript.src="https://js.zohocdn.com/salesiq/https/js/track_6a6df2d62afd8d014fdccc6a264c0bfa_.js";  //No I18N
  headArr[0].appendChild(oscript);//No I18N
}
...
function ZaddEvent()
{
  	...
  	var iframeurl = "https://salesiq.zohopublic.com/toolshardwaresupplies/drawchat.ls?";  	
    var _zldcpage = "http://www.toolshardwarejamaica.com/"; 
  ...
  _ZSIQ.initSIQAPI = _ZSIQ.initSIQAPI || function()   //No I18N
  {
    ...
    var floatcookie = readCookie('zld75580000000002027float');//No I18N
	...
	lsid:'75580000000002027' // NO I18N
	};
	try
	{
  ...
  _ZSIQ.initFloat = function()//No I18N
  {
	Float.newembed = false;//No I18N
        ...
        Float.lsobject={"autochat":"false","clickchat":"false","name":"","email":"","ques":"","department":"","embedname":"toolshardwaresupplies","lsid":"75580000000002027","bgcolor":"","oncontent":"Leave a message","icon":"7","buttontheme":"blue-btn","oncontentcolor":"","status":"off","statustext":"Offline","serverurl":"https://salesiq.zohopublic.com","url":"https://salesiq.zohopublic.com/toolshardwaresupplies/drawchat.ls?","floatposition":"bottomright","top":"0","bottom":"0","left":"0","right":"0","flipicon":"false","aligntoright":"false","floatmeasurement":"px","headercolor":"","sbicobg":"","fltsize":"small","mobileoncontent":"common.mobile.chat","ipadoncontent":"infomsg.mobile.chatwithus","mobileoffcontent":"infomsg.mobile.offline"}; 
        Float.lsobject["imgurl"] = "https://img.zohostatic.com/salesiq/JULY_13_2021_07_https";  
		...
		Float.lsobject["screenname"]="toolshardwaresupplies" ;
		...
		Float.lsobject.currdomain = "toolshardwarejamaica.com";
		Float.lsobject["float_fkey"]="0_75580000000002027"; 
